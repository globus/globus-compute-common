...
from funcx_common.sdk_version_sharing import (
    FUNCX_VERSION_PREFIX,
...
def test_user_agent_substring(version: str):
    ...
    assert FUNCX_VERSION_PREFIX in substring
...
def test_parse_version_number(version: str, template: str):
    user_agent_string = template.format(FUNCX_VERSION_PREFIX, version)
